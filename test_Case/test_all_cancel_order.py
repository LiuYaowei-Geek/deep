    ...
    def test_1_shuj(self):
        ...
        for i in token_test['token']:
            ...
            if type_c[0] ==2:  # 判断是否全仓还是逐仓
                ...
                contract_type = {"contract_type": '1'}  # 是逐仓换成全仓
            ...
            # 撤单二笔记录
            print('----------------------------------------------------------------------------------------------')
            paramt2 = {'order_id': plan_order_2}
            api_json_4 = requests_single(url=host_duo3, requersts_type=qingqiu3_duo, paramt=paramt2, headers=i)
