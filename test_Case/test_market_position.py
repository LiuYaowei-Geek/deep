...
excel_zhang = read_excel(wenjian, '市价买跌')
excel_die = read_excel(wenjian, '市价买涨')
db_link=db_commit()
rise='315908'
drop='315896'
...
class Test_Login_Limit(unittest.TestCase):
    ...
    def test_1_shuj(self,data):
        ...
        paramt={'quantity':quantity,'lever':lever,'bs_flag':bs_flag,'order_type':order_type,'contract_id':contract_id} #拼接参数
        print(paramt)
